      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-500">
            ...
            top-quality training and coaching in various sports disciplines. We
            are committed to helping athletes of all ages and skill levels reach
            their full potential and achieve excellence in their chosen sports.
          </p>
        </div>
        <div className="mt-10">
        ...
        <div className="mt-10">
          <h3 className="text-xl font-medium text-gray-900">Our Facilities</h3>
          <p className="mt-4 text-base text-gray-500">
            With state-of-the-art training facilities and equipment, Sport Learn
            provides athletes with a conducive environment to train and improve.
            Our modern facilities include well-maintained sports fields, indoor
            training areas, strength and conditioning zones, and more, allowing
            athletes to train effectively and efficiently.
          </p>
        </div>
      </div>
    </div>
